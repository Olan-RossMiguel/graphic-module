...
export const StudentRow = ({ estudiante, testStatus, onDownloadReport }) => {
    ...
    return (
        <tr className="transition-colors hover:bg-gray-50">
            ...
            {/* Test de Asistencia Psicológica (NUEVO) */}
            <td className="whitespace-nowrap px-6 py-4 text-center">
                <TestStatusIcon
                    completed={testStatus.asistencia}
                    testName="Asistencia Psicológica"
                />
            </td>
            ...
            <td className="whitespace-nowrap px-6 py-4 text-sm font-medium">
                <div className="flex justify-center space-x-2">
                    <Link
                        href={route('psychologist.students.report.general', {
                    ...
                    <Link
                        href={route('psychologist.students.show', {
                            student: estudiante.id,
                        })}
