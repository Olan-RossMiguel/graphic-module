...
export default function StudentDashboard({ user, stats, completed_results }) {
    // Valores por defecto si no llegan los datos
    ...
    const safeResults = completed_results || [];
    const safeUser = user || {};
    ...
    const testIcons = {
        ...
        evaluacion_psicologica: FaHeartbeat, // ✅ Añadido
    };
    ...
    const testColors = {
        ...
        evaluacion_psicologica: 'from-red-500 to-red-600', // ✅ Añadido
    };
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">
                            ¡Hola, {safeUser.nombre || 'Estudiante'}!
                        </h1>
                        ...
                        <div className="rounded-xl border-l-4 border-purple-500 bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-2 text-3xl font-bold text-gray-900">
                                        {safeStats.completion_percentage}%
                                    </p>
                                </div>
                            ...
                            <div className="mt-3 h-2 w-full rounded-full bg-gray-200">
                                <div
                                    ...
                                    style={{
                                        width: `${safeStats.completion_percentage}%`,
                                    }}
                                />
                            </div>
                        </div>
                    ...
                    {/* Quick Actions */}
                    {safeResults.length > 0 && safeStats.pending_tests > 0 && (
                            ...
                            <div className="flex flex-col items-center justify-between sm:flex-row">
                                <div className="mb-4 sm:mb-0">
                                    ...
                                    <p className="text-blue-100">
                                        Aún tienes {safeStats.pending_tests}{' '}
                                        test
                                        {safeStats.pending_tests !== 1
                                            ? 's'
                                            : ''}{' '}
                                        pendiente
                                        {safeStats.pending_tests !== 1
