...
import { StudentTable } from '@/Components/UI/tests/psychologist/StudentTable';
import PsychologistLayout from '@/Layouts/UI/PsychologistLayout';
import { Link } from '@inertiajs/react';
import { FaArrowLeft } from 'react-icons/fa';

export default function PsychologistGroupShow({
    auth,
    group,
    semestre,
    estudiantes,
}) {
    // Función para obtener el estado de los tests (incluyendo asistencia psicológica)
    const getTestStatus = (estudiante) => {
        return (
            estudiante.tests_completados || {
                ...
                emocional: false,
                habilidades: false,
                asistencia: false, // ✅ Test adicional para psicóloga
            }
        );
    };
    ...
    return (
        <PsychologistLayout user={auth.user}>
            <div className="space-y-6">
                ...
                {/* Tabla de estudiantes con 4 tests */}
                <StudentTable
