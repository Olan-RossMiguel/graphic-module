...
export default function TestCompletedEmotionalIntelligence({
    test,
    result,
    chartData,
    insights,
            ...
            <div className="mx-auto max-w-6xl py-12">
                ...
                <div className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg">
                    ...
                    <div className="px-8 py-8">
                        {/* Nivel Destacado */}
                        {result?.nivel && (
                            <div className="mb-8 rounded-xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 shadow-sm">
                                <div className="mb-4 flex items-center justify-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-blue-600">
                                            Tu nivel de Inteligencia Emocional:
                                        </p>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="border-l-4 border-green-500 bg-green-50 p-4">
                                    <p className="text-sm text-green-800">
                                        ...
                                        desarrollar con práctica constante.
                                    </p>
                                </div>
                            </div>
                ...
                <div className="mt-6 text-center text-sm text-gray-600">
                    <p>
                        💡 Tip: Repite este test cada 3-6 meses para medir tu
                        progreso en inteligencia emocional.
                    </p>
                </div>
            </div>
        </StudentLayout>
